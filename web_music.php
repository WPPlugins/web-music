...
Description: Put in your post players Goear, Evoca, Ijigg and MyBloop to play music or recordings. To use: [mus]url[/mus].
Version: 1.1
...
function insertar($salida) {
	...
	if (preg_match_all ($pattern, $salida, $matches)) {
		...
		for ($i = 0; $i < count($matches[0]); $i++) {
			...
			$htmlcode .= "<br><sup><a href='http://www.minyatur.com.ar/web-music/'>Web Music 1.1</a></sup>";	
			$htmlcode .= '</div>';
